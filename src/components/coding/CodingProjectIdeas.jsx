...
const projectIdeas = [
  ...
  },
  {
    ...
    description:
      "Entwickle eine To-Do-App mit Funktionen wie Priorisierung, Fälligkeitsdaten und Benutzerauthentifizierung (z.B. mit localStorage oder Supabase).",
    ...
    tutorialLink: "https://www.freecodecamp.org/news/how-to-build-a-todo-app-with-react/", // Externes Tutorial als Beispiel
  },
  {
        ...
        <Card key={index} className="card-hover border-border/50 bg-card/70 backdrop-blur-lg overflow-hidden shadow-lg hover:shadow-primary/20 transition-all duration-300 ease-out flex flex-col group transform hover:-translate-y-1">
          ...
          <CardContent className="p-6 pt-0 flex-grow">
            <div className="aspect-[16/10] rounded-md overflow-hidden mb-4 shadow-inner">
               <img src={project.imgSrc} alt={project.imgAlt} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
            </div>
